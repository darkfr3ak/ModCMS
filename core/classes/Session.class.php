...
class Session {
    ...
    public static function read($id) {
        $sql = sprintf("SELECT `session_data` FROM `mycms_core_session` " .
    ...
    public static function write($id, $data) {
        $sql = sprintf("INSERT INTO `mycms_core_session` SET
                        session_id='%s', 
                        session_started=NOW(),
    ...
    public static function destroy($id) {
        $sql = sprintf("DELETE FROM `mycms_core_session` WHERE `session_id` = '%s'", $id);
    ...
    public static function gc($max) {
        $sql = sprintf("DELETE FROM `mycms_core_session` WHERE `session_expires` < '%s'",
            (time() - $max)
        );
        return self::$db->query($sql);
    }
